...
.then(result => {
    ...
    var secondReceiver = accounts[parseInt(process.argv[4])];
    var amount = gnosisInstance['web3'].toWei(1.58,"ether");
    ...
    var amount = gnosisInstance['web3'].toWei(0.42,"ether");
    gnosisInstance['web3']['eth'].sendTransaction({from:sender, to:secondReceiver, value:amount});
